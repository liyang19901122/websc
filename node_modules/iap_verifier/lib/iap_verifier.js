...
(function() {
  ...
  IAPVerifier = (function() {
    ...
    function IAPVerifier(password, production, debug) {
    ...
    */
    ...
    IAPVerifier.prototype.verifyWithRetry = function(receiptData, receipt, cb) {
      ...
      return this.verify(receiptData, receipt, this.requestOptions(), function(valid, msg, data) {
        var options;
        if ((21007 === data.status) && (_this.productionHost === _this.host)) {
          if (_this.debug) {
            console.log("Retry on Sandbox");
          }
          options = _this.requestOptions();
          options.host = _this.sandboxHost;
          return _this.verify(receiptData, receipt, options, function(valid, msg, data) {
            if (this.debug) {
    ...
    IAPVerifier.prototype.verify = function(data, receipt, options, cb) {
      ...
      request = https.request(options, function(response) {
        ...
        return response.on('data', function(data) {
          ...
          return _this.processStatus(responseData, cb);
        });
      });
